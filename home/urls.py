...
urlpatterns = [
    ...
    path("variant_mapper/", cache_page(3600*24*365)(variant_mapper), name='variant_mapper'),
    path("get_chromosome_mapping/", get_chromosome_mapping, name='get_chromosome_mapping'),
    path("get_variant_mapping/", get_variant_mapping, name='get_variant_mapping'),
    path("get_chromosome_mapping_example/", get_chromosome_mapping_example, name='get_chromosome_mapping_example'),
    path("get_variant_mapping_example/", get_variant_mapping_example, name='get_variant_mapping_example'),
