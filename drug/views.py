                            ...
                            "clinical_data": [
                                {
                                    ...
                                    "Study_Cases": str(int(item.Study_Cases) if (isinstance(item.Study_Cases, float) and not np.isnan(item.Study_Cases)) else item.Study_Cases),
                                    "Study_Controls": str(int(item.Study_Controls) if (isinstance(item.Study_Controls, float) and not np.isnan(item.Study_Controls)) else item.Study_Controls),
