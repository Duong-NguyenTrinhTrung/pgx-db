...
# subprocess.run(['python', 'manage.py', 'build_disease'])
# subprocess.run(['python', 'manage.py', 'build_drug_disease_study'])
# subprocess.run(['python', 'manage.py', 'build_chromosome_mapping'])
# subprocess.run(['python', 'manage.py', 'build_drug_phenocode'])

# subprocess.run(['python', 'manage.py', 'build_variant_phenocode'])
# subprocess.run(['python', 'manage.py', 'build_variant_marker'])
# subprocess.run(['python', 'manage.py', 'build_variant_marker_DO_version'])
# subprocess.run(['python', 'manage.py', 'build_vep_variant_DO_version'])
subprocess.run(['python', 'manage.py', 'build_genebass_genebased_pgx_DO_version'])
# subprocess.run(['python', 'manage.py', 'build_genebass_variant'])