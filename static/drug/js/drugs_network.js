...
//jsonFiles
var json_GeneralFile = "/drugs-network/general-data?drug_bank_ids=" + drug_bank_ids.join(',');
var json_drugData = "/drugs-network/drug-data?drug_bank_ids=" + drug_bank_ids.join(',');
var json_proteinData = "/drugs-network/protein-data?drug_bank_ids=" + drug_bank_ids.join(',');
var json_interactionData = "/drugs-network/interaction-data?drug_bank_ids=" + drug_bank_ids.join(',');
