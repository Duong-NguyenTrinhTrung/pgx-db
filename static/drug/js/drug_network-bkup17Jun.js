$(function () {
  ...
  function readDrugJSON() {
    $.ajax({
      url: '/serve_json_file/?atc_code=' + atc_code,
      method: "GET",
      
      success: function (data) {
        drug_xlsxData = data.drug_data;
        protein_xlsxData = data.protein_data;
        interaction_xlsxData = data.interaction_data;
        processData(numberofnodes, slicedata);
        general_xlsxData = data.general_data;
      },
