...
#This script is use to replace "build_adding_protein_super_class.py" with Zia latest data
    ...
    def handle(self, *args, **options):
        ...
        if not filenames:
            filenames = [
                ...
                if fn.endswith("protein_data_Zia_with_updated_protein_classes.csv")
            ]
            print(filenames)
        count=0
