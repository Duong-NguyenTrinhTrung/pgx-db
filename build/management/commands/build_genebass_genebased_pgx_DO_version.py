...
class Command(BaseCommand):
    ...
    def create_gb_pgx_class_data(self, filenames=False):
        ...
        for filename in filenames:
            ...
            #;gene_id;annotation;n_cases;n_controls;phenocode;description;coding_description;name;Pvalue;Pvalue_Burden;Pvalue_SKAT;BETA_Burden;SE_Burden;drugbank_id
