...
class Command(BaseCommand):
    ...
    def count_drug_protein_disease_nodes_level5(self):
        ...
        with open("Data/StatisticForPlotting/Calculation_of_network_nodes_per_atc_level5.csv", "w") as f:
            ...
            for i,c in enumerate(allChemicalSubstanceCodes):
                ...
                disease_count = len(list(set(DrugDiseaseStudy.objects.filter(drug_bankID__in=drugs).values_list("disease_name__disease_name", flat=True))))
                association_count=len(DrugDiseaseStudy.objects.filter(drug_bankID__in=drugs))
    ...
    def count_drug_protein_disease_nodes_level4(self):
        ...
        with open("Data/StatisticForPlotting/Calculation_of_network_nodes_per_atc_level4.csv", "w") as f:
            for i,cg in enumerate(allChemicalGroupCodes):
                ...
                for i,sc in enumerate(all_substance_codes):
                    ...
                    #disease
                    diseases = list(set(DrugDiseaseStudy.objects.filter(drug_bankID__in=drugs).values_list("disease_name__disease_name", flat=True)))
                    disease_list+=diseases
                    #association
                    associations=DrugDiseaseStudy.objects.filter(drug_bankID__in=drugs)
    ...
    def count_drug_protein_disease_nodes_level3(self):
        ...
        with open("Data/StatisticForPlotting/Calculation_of_network_nodes_per_atc_level3.csv", "w") as f:
    ...
    def count_drug_protein_disease_nodes_level2(self):
        ...
        with open("Data/StatisticForPlotting/Calculation_of_network_nodes_per_atc_level2.csv", "w") as f:
    ...
    def count_drug_protein_disease_nodes_level1(self):
        ...
        with open("Data/StatisticForPlotting/Calculation_of_network_nodes_per_atc_level1.csv", "w") as f:
